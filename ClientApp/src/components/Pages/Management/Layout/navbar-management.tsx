...
export const NavbarManagement: React.FC = () => {
  return (
    <>
      <div className="bg-white rounded p-3 h-screen w-1/4">
        ...
        <ul className="space-y-2 text-sm">
          <NavItem>
            <NavLink className="flex items-center space-x-3 text-gray-700 p-2 rounded-md font-medium hover:bg-gray-200 bg-gray-200 focus:shadow-outline">
